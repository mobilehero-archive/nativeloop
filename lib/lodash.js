...
(function() {
    ...
    var freeExports = "object" == ("undefined" == typeof exports ? "undefined" : _typeof(exports)) && exports && !exports.nodeType && exports;
    ...
    var runInContext = function runInContext(context) {
        ...
        function lazyValue() {
            ...
            var result = [];
            outer: while (length-- && takeCount > resIndex) {
                index += dir;
        ...
        function baseClamp(number, lower, upper) {
            if (number === number) {
                upper !== undefined && (number = upper >= number ? number : upper);
        ...
        function baseGet(object, path) {
            ...
            while (null != object && length > index) object = object[toKey(path[index++])];
        ...
        function baseIteratee(value) {
            ...
            if ("object" == ("undefined" == typeof value ? "undefined" : _typeof(value))) return isArray(value) ? baseMatchesProperty(value[0], value[1]) : baseMatches(value);
        ...
        function composeArgs(args, partials, holders, isCurried) {
            ...
            while (++argsIndex < holdersLength) (isUncurried || argsLength > argsIndex) && (result[holders[argsIndex]] = args[argsIndex]);
        ...
        function composeArgsRight(args, partials, holders, isCurried) {
            ...
            while (++holdersIndex < holdersLength) (isUncurried || argsLength > argsIndex) && (result[offset + holders[holdersIndex]] = args[argsIndex++]);
            return result;
        }
        ...
        function createCurry(func, bitmask, arity) {
            function wrapper() {
                ...
                if (arity > length) return createRecurry(func, bitmask, createHybrid, wrapper.placeholder, undefined, args, holders, undefined, undefined, arity - length);
                var fn = this && this !== root && this instanceof wrapper ? Ctor : func;
        ...
        function createRange(fromRight) {
            return function(start, end, step) {
                ...
                step = step === undefined ? end > start ? 1 : -1 : toFinite(step);
        ...
        function isIndex(value, length) {
            ...
            return !!length && ("number" == typeof value || reIsUint.test(value)) && value > -1 && value % 1 == 0 && length > value;
        }
        function isIterateeCall(value, index, object) {
            if (!isObject(object)) return false;
            var type = "undefined" == typeof index ? "undefined" : _typeof(index);
        ...
        function chunk(array, size, guard) {
            ...
            while (length > index) result[resIndex++] = baseSlice(array, index, index += size);
            return result;
        }
        ...
        function drop(array, n, guard) {
            ...
            return baseSlice(array, 0 > n ? 0 : n, length);
        }
        function dropRight(array, n, guard) {
            ...
            n = guard || n === undefined ? 1 : toInteger(n);
            n = length - n;
            return baseSlice(array, 0, 0 > n ? 0 : n);
        }
        ...
        function findLastIndex(array, predicate, fromIndex) {
            ...
            if (fromIndex !== undefined) {
                ...
                index = 0 > fromIndex ? nativeMax(length + index, 0) : nativeMin(index, length - 1);
            }
        ...
        function lastIndexOf(array, value, fromIndex) {
            ...
            if (fromIndex !== undefined) {
                index = toInteger(fromIndex);
                index = 0 > index ? nativeMax(length + index, 0) : nativeMin(index, length - 1);
            }
        ...
        function includes(collection, value, fromIndex, guard) {
            ...
            return isString(collection) ? length >= fromIndex && collection.indexOf(value, fromIndex) > -1 : !!length && baseIndexOf(collection, value, fromIndex) > -1;
        }
        ...
        function isSymbol(value) {
            return "symbol" == ("undefined" == typeof value ? "undefined" : _typeof(value)) || isObjectLike(value) && baseGetTag(value) == symbolTag;
        }
        ...
        function times(n, iteratee) {
            n = toInteger(n);
            if (1 > n || n > MAX_SAFE_INTEGER) return [];
        ...
        LazyWrapper.prototype.slice = function(start, end) {
            start = toInteger(start);
            var result = this;
            if (result.__filtered__ && (start > 0 || 0 > end)) return new LazyWrapper(result);
            0 > start ? result = result.takeRight(-start) : start && (result = result.drop(start));
            if (end !== undefined) {
                end = toInteger(end);
                result = 0 > end ? result.dropRight(-end) : result.take(end - start);
            }
            return result;
        };
